 ...
 */
final class Version20220106071802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category ADD parent_category_id INT DEFAULT NULL, ADD rank INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category DROP parent_category_id, DROP rank');
    }
}
