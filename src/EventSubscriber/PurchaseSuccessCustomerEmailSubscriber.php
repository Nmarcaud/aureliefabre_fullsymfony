...
class PurchaseSuccessCustomerEmailSubscriber implements EventSubscriberInterface
{
    ...
    public function sendSuccessEmail(PurchaseSuccessEvent $purchaseSuccesEvent)
    {
        ...
        $customerEmail
            ->from(new Address("no-reply@aureliefabre.com", "Institut Aurélie Fabre")) // Objet Address avec mail et nom
